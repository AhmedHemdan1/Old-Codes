...
MODEL               = vdp
MODULES             = rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c vdp_data.c 
MAKEFILE            = vdp.mk
...
MODELLIB                  = vdplib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = vdp_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/vdp \
	-I$(START_DIR) \
	-I$(MATLAB_ROOT)/toolbox/simulink/simdemos/simgeneral \
